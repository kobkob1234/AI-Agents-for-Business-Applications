...
def migrate_data():
    ...
    print(f"Found {len(target_files)} CSV files from 2015-2026.")
        ...
        try:
            ...
            for _, row in df.iterrows():
                try:
                    ...
                    # Date parsing
                    raw_date = str(row.get('Date', '')) # YYYYMM
                    event_date = None
                    try:
    ...
    print(f"\n✅ Migration Complete. Uploaded {total_uploaded} records.")
