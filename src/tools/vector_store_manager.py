...
class VectorStoreManager:
    ...
    def get_vector_store(self):
        """
        Returns the appropriate vector store based on environment variables.
        Priority: Pinecone (if API key exists) -> Chroma (Local).
        """
    ...
    def create_pinecone_index_if_needed(self):
        """
        Helper to create index if it doesn't exist (One-time setup).
        """
