...
*   **Must include:** description, purpose, prompt templates, prompt examples and full responses.
*   **Response format (JSON):**
    ```json
    {
      "description": "...",
...
*   **Steps:**
    ...
    *   You must include: module/submodule name (must correlate to architecture diagram), prompt, response.
...
*   Display the full steps trace (steps), including: module, prompt, Response.
...
### Deployment
Deploy your agent on Render (https://render.com). Keep your account active until receiving a grade.
